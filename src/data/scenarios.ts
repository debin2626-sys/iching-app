...
export const scenarios: Scenario[] = [
  {
    id: "career",
    emoji: "💼",
    name: { zh: "事业", en: "Career" },
    description: { zh: "事业发展中的关键抉择", en: "Key decisions in career development" },
    subScenarios: [
      {
        id: "civil-exam",
        name: { zh: "考公/考编", en: "Civil Service Exam" },
        template: {
      ...
      {
        id: "project-decision",
        name: { zh: "项目决策", en: "Project Decision" },
        template: {
  ...
  },
  {
    ...
    emoji: "💕",
    name: { zh: "感情", en: "Love" },
    description: { zh: "情感关系中的困惑与抉择", en: "Confusion and choices in relationships" },
    subScenarios: [
      {
        id: "confession",
      ...
      {
        id: "reconciliation",
        name: { zh: "复合挽回", en: "Reconciliation" },
        template: {
  ...
  },
  {
    id: "wealth",
    emoji: "💰",
    name: { zh: "财运", en: "Wealth" },
    description: { zh: "财富决策中的风险与机遇", en: "Risks and opportunities in financial decisions" },
    subScenarios: [
      {
        id: "investment",
        name: { zh: "投资决策", en: "Investment" },
        template: {
      ...
      {
        id: "finance",
        name: { zh: "理财规划", en: "Financial Planning" },
        template: {
  ...
  },
  {
    ...
    emoji: "📚",
    name: { zh: "学业", en: "Study" },
    description: { zh: "求学路上的迷茫与选择", en: "Confusion and choices on the academic path" },
    subScenarios: [
      {
        id: "exam",
        name: { zh: "考试运势", en: "Exam Fortune" },
        template: {
      ...
      {
        id: "school",
        name: { zh: "升学择校", en: "School Selection" },
        template: {
  ...
  },
  {
    ...
    description: { zh: "身心健康的关注与调养", en: "Attention and care for physical and mental health" },
    subScenarios: [
      {
        id: "physical",
        name: { zh: "身体状况", en: "Physical Health" },
        template: {
